 ...
 *  </copyright>
 */
#ifndef _IODRVSUBMODULESSLOTDEP_H_
#define _IODRVSUBMODULESSLOTDEP_H_

#define COMPONENT_NAME "IoDrvSubModulesSlot" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvSubModulesSlot)
#define COMPONENT_NAME_UNQUOTED IoDrvSubModulesSlot
...
#ifndef IODRVSUBMODULESSLOT_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
                                
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVSUBMODULESSLOT_DISABLE_EXTREF2
#define EXPORT_EXTREF2_STMT \
                                
#else
#define EXPORT_EXTREF2_STMT
#endif
#if !defined(IODRVSUBMODULESSLOT_DISABLE_CMPITF) && !defined(STATIC_LINK) && !defined(CPLUSPLUS) && !defined(CPLUSPLUS_ONLY)
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvSubModulesSlot__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvSubModulesSlot : public ICmpIoDrv 
{
    public:
        CIoDrvSubModulesSlot() : hIoDrvSubModulesSlot(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvSubModulesSlot()
        {
        }
    ...
    public:
        RTS_HANDLE hIoDrvSubModulesSlot;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvSubModulesSlot Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvSubModulesSlot_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvSubModulesSlot_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
