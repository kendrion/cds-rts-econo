...
#define _IODRVSOUNDDEMODEP_H_

#define COMPONENT_NAME "IoDrvSoundDemo" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvSoundDemo)
#define COMPONENT_NAME_UNQUOTED IoDrvSoundDemo
...
#ifndef IODRVSOUNDDEMO_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
                                    
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVSOUNDDEMO_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvSoundDemo__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvSoundDemo : public ICmpIoDrv , public ICmpIoDrvParameter 
{
    public:
        CIoDrvSoundDemo() : hIoDrvSoundDemo(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvSoundDemo()
        {
        }
    ...
    public:
        RTS_HANDLE hIoDrvSoundDemo;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvSoundDemo Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvSoundDemo_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvSoundDemo_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
