...
/* CmpTemplateEmpty Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpTemplateEmpty_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpTemplateEmpty_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
