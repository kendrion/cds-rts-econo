 ...
 *  </copyright>
 */
#ifndef _IODRVSUBMODULESFIXDEP_H_
#define _IODRVSUBMODULESFIXDEP_H_

#define COMPONENT_NAME "IoDrvSubModulesFix" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvSubModulesFix)
#define COMPONENT_NAME_UNQUOTED IoDrvSubModulesFix
...
#ifndef IODRVSUBMODULESFIX_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
                                
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVSUBMODULESFIX_DISABLE_EXTREF2
#define EXPORT_EXTREF2_STMT \
                                
#else
#define EXPORT_EXTREF2_STMT
#endif
#if !defined(IODRVSUBMODULESFIX_DISABLE_CMPITF) && !defined(STATIC_LINK) && !defined(CPLUSPLUS) && !defined(CPLUSPLUS_ONLY)
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvSubModulesFix__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvSubModulesFix : public ICmpIoDrv 
{
    public:
        CIoDrvSubModulesFix() : hIoDrvSubModulesFix(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvSubModulesFix()
        {
        }
    ...
    public:
        RTS_HANDLE hIoDrvSubModulesFix;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvSubModulesFix Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvSubModulesFix_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvSubModulesFix_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
