...
#define _IODRVTARGETDEP_H_

#define COMPONENT_NAME "IoDrvTarget" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvTarget)
#define COMPONENT_NAME_UNQUOTED IoDrvTarget
...
#ifndef IODRVTARGET_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
                                                        
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVTARGET_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvTarget__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvTarget : public ICmpIoDrv , public ICmpIoDrvParameter , public ICmpIoDrvDPV1C1Master , public ICmpIoDrvDPV1C1Slave 
{
    public:
        CIoDrvTarget() : hIoDrvTarget(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvTarget()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            ...
            else if (iid == ITFID_ICmpIoDrvDPV1C1Master)
                pItf = dynamic_cast<ICmpIoDrvDPV1C1Master *>(this); 
            else if (iid == ITFID_ICmpIoDrvDPV1C1Slave)
                pItf = dynamic_cast<ICmpIoDrvDPV1C1Slave *>(this); 
            else
            {
                if (pResult != NULL)
        ...
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_S_RegisterRecvCallback(ICmpEventCallback *pICallback);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_S_UnregisterRecvCallback(ICmpEventCallback *pICallback);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_S_RegisterRecvCallbackFunction(PFEVENTCALLBACKFUNCTION pfCallbackFunction, int bIec);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_S_UnregisterRecvCallbackFunction(PFEVENTCALLBACKFUNCTION pfCallbackFunction);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_S_Write(DPV1_C1_Write *pWrite);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_M_Read(DPV1_C1_Read *pRead);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_M_Write(DPV1_C1_Write *pWrite);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_M_Alarm(DPV1_C1_Alarm *pAlarm);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_M_AlarmAck(DPV1_C1_AlarmAck *pAlarmAck);
        virtual RTS_RESULT CDECL IIoDrvDPV1_C1_M_Status(DPV1_C1_Status *pStatus);
    ...
    public:
        RTS_HANDLE hIoDrvTarget;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvTarget Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvTarget_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvTarget_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
