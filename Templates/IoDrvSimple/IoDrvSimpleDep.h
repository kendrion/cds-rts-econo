 ...
 *  </copyright>
 */
#ifndef _IODRVSIMPLEDEP_H_
#define _IODRVSIMPLEDEP_H_

#define COMPONENT_NAME "IoDrvSimple" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvSimple)
#define COMPONENT_NAME_UNQUOTED IoDrvSimple
...
/**
 * \file IoDrvSimpleItf.h
 */
#include "IoDrvSimpleItf.h"
...
#ifndef IODRVSIMPLE_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
                                    
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVSIMPLE_DISABLE_EXTREF2
#define EXPORT_EXTREF2_STMT \
                                    
#else
#define EXPORT_EXTREF2_STMT
#endif
#if !defined(IODRVSIMPLE_DISABLE_CMPITF) && !defined(STATIC_LINK) && !defined(CPLUSPLUS) && !defined(CPLUSPLUS_ONLY)
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvSimple__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvSimple : public IIoDrvSimple , public ICmpIoDrv , public ICmpIoDrvParameter 
{
    public:
        CIoDrvSimple() : hIoDrvSimple(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvSimple()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((IIoDrvSimple *)this);            
            else if (iid == ITFID_IIoDrvSimple)
                pItf = dynamic_cast<IIoDrvSimple *>(this); 
    ...
    public:
        RTS_HANDLE hIoDrvSimple;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvSimple Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvSimple_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvSimple_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
