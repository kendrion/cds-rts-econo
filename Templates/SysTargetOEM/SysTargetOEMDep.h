...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry SysTargetOEM__Entry
#endif


#ifdef CPLUSPLUS

class CSysTargetOEM : public ISysTarget 
{
    public:
        CSysTargetOEM() : hSysTargetOEM(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CSysTargetOEM()
        {
        }
...
/* SysTargetOEM Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT SysTargetOEM_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF SysTargetOEM_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
