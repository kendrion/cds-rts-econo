...
int CmpSecureChannel__Entry(INIT_STRUCT *pInitStruct); \
int CmpSecurityManager__Entry(INIT_STRUCT *pInitStruct); \
int CmpSessionInformation__Entry(INIT_STRUCT *pInitStruct); \
...
{"CmpSecureChannel", CmpSecureChannel__Entry, 0}, \
{"CmpSecurityManager", CmpSecurityManager__Entry, 0}, \
{"CmpSessionInformation", CmpSessionInformation__Entry, 0}, \
