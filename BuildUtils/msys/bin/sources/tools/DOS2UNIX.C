...
/*
  Revisionsliste:
<CODE>
  22.05.2012, Die zum Schreiben geöffneten Dateien wurden mit dem Flag "Commit" ("wbc") versehen.
              Die sporadischen Fehler beim Übersetzen der m4's im Buildprozess der Plattform auf Mehrkern-PCs scheinen damit beseitigt.
</CODE>
*/
