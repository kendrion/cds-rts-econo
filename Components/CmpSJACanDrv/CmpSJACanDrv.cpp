...
int CDECL CCmpSJACanDrv::ISJA_CanMiniDriver_Setup(void)
{
	return SJA_CanMiniDriver_Setup();
}

int CDECL CCmpSJACanDrv::ISJA_CanMiniDriver_Dispose(void)
{
	return SJA_CanMiniDriver_Dispose();
}

DEV_INFO* CDECL CCmpSJACanDrv::ISJA_GetDeviceDescription(int iDev)
{
	return SJA_GetDeviceDescription(iDev);
}
