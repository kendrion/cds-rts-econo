 ...
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `HandleVisuService', `(RTS_UI32 ulChannelId, HEADER_TAG *pHeaderTag, PROTOCOL_DATA_UNIT pduData, PROTOCOL_DATA_UNIT *pduSendBuffer)')
 ...
 * <result>Error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `RemoveClientsAndContinuationInfo', `(RTS_UI32 ulChannelId)')
