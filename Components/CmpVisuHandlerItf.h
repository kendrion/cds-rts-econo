...
typedef EventStruct2 VisuStructEvent2;
...
/**
 * | This function can be used to configure the settings of the event buffer within the runtime 
 * | system. It must be called only once during startup of an application.
 * :return: The runtime system error code (see CmpErrors.library)
 * link even in simulation mode
 */
typedef struct tagvishconfigureeventbuffer_struct
{
 ...
 an address that is aligned to keep 8 byte sized values.
 This mechanism can be used for declarations of a VisuStructIECEvent structure
 to which a POINTER TO VisuStructEvent can then be casted. */
	RTS_IEC_BOOL xMergeEvents;			/* VAR_INPUT */	
	RTS_IEC_RESULT VishConfigureEventBuffer;	/* VAR_OUTPUT */	
} vishconfigureeventbuffer_struct;

void CDECL CDECL_EXT vishconfigureeventbuffer(vishconfigureeventbuffer_struct *p);
typedef void (CDECL CDECL_EXT* PFVISHCONFIGUREEVENTBUFFER_IEC) (vishconfigureeventbuffer_struct *p);
#if defined(CMPVISUHANDLER_NOTIMPLEMENTED) || defined(VISHCONFIGUREEVENTBUFFER_NOTIMPLEMENTED)
	#define USE_vishconfigureeventbuffer
	#define EXT_vishconfigureeventbuffer
	#define GET_vishconfigureeventbuffer(fl)  ERR_NOTIMPLEMENTED
	#define CAL_vishconfigureeventbuffer(p0) 
	#define CHK_vishconfigureeventbuffer  FALSE
	#define EXP_vishconfigureeventbuffer  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_vishconfigureeventbuffer
	#define EXT_vishconfigureeventbuffer
	#define GET_vishconfigureeventbuffer(fl)  CAL_CMGETAPI( "vishconfigureeventbuffer" ) 
	#define CAL_vishconfigureeventbuffer  vishconfigureeventbuffer
	#define CHK_vishconfigureeventbuffer  TRUE
	#define EXP_vishconfigureeventbuffer  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishconfigureeventbuffer", (RTS_UINTPTR)vishconfigureeventbuffer, 1, 0x44C4FEA3, 0x03050E00) 
#elif defined(MIXED_LINK) && !defined(CMPVISUHANDLER_EXTERNAL)
	#define USE_vishconfigureeventbuffer
	#define EXT_vishconfigureeventbuffer
	#define GET_vishconfigureeventbuffer(fl)  CAL_CMGETAPI( "vishconfigureeventbuffer" ) 
	...
	#define EXP_vishconfigureeventbuffer  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishconfigureeventbuffer", (RTS_UINTPTR)vishconfigureeventbuffer, 1, 0x44C4FEA3, 0x03050E00) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpVisuHandlervishconfigureeventbuffer
	#define EXT_CmpVisuHandlervishconfigureeventbuffer
	#define GET_CmpVisuHandlervishconfigureeventbuffer  ERR_OK
	#define CAL_CmpVisuHandlervishconfigureeventbuffer  vishconfigureeventbuffer
	#define CHK_CmpVisuHandlervishconfigureeventbuffer  TRUE
	#define EXP_CmpVisuHandlervishconfigureeventbuffer  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishconfigureeventbuffer", (RTS_UINTPTR)vishconfigureeventbuffer, 1, 0x44C4FEA3, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_vishconfigureeventbuffer
	#define EXT_vishconfigureeventbuffer
	#define GET_vishconfigureeventbuffer(fl)  CAL_CMGETAPI( "vishconfigureeventbuffer" ) 
	...
	#define EXP_vishconfigureeventbuffer  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishconfigureeventbuffer", (RTS_UINTPTR)vishconfigureeventbuffer, 1, 0x44C4FEA3, 0x03050E00) 
#else /* DYNAMIC_LINK */
	#define USE_vishconfigureeventbuffer  PFVISHCONFIGUREEVENTBUFFER_IEC pfvishconfigureeventbuffer;
	#define EXT_vishconfigureeventbuffer  extern PFVISHCONFIGUREEVENTBUFFER_IEC pfvishconfigureeventbuffer;
	#define GET_vishconfigureeventbuffer(fl)  s_pfCMGetAPI2( "vishconfigureeventbuffer", (RTS_VOID_FCTPTR *)&pfvishconfigureeventbuffer, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x44C4FEA3, 0x03050E00)
	#define CAL_vishconfigureeventbuffer  pfvishconfigureeventbuffer
	#define CHK_vishconfigureeventbuffer  (pfvishconfigureeventbuffer != NULL)
	#define EXP_vishconfigureeventbuffer   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishconfigureeventbuffer", (RTS_UINTPTR)vishconfigureeventbuffer, 1, 0x44C4FEA3, 0x03050E00) 
#endif
 ...
 * link even in simulation mode
 */
typedef struct tagvishgetcurrentevent2_struct
{
	RTS_IEC_STRING *stAppName;			/* VAR_IN_OUT */	/* The name of the application where to get the event from the queue */
	VisuStructEvent2 *VishGetCurrentEvent2;	/* VAR_OUTPUT */	
} vishgetcurrentevent2_struct;

void CDECL CDECL_EXT vishgetcurrentevent2(vishgetcurrentevent2_struct *p);
typedef void (CDECL CDECL_EXT* PFVISHGETCURRENTEVENT2_IEC) (vishgetcurrentevent2_struct *p);
#if defined(CMPVISUHANDLER_NOTIMPLEMENTED) || defined(VISHGETCURRENTEVENT2_NOTIMPLEMENTED)
	#define USE_vishgetcurrentevent2
	#define EXT_vishgetcurrentevent2
	#define GET_vishgetcurrentevent2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_vishgetcurrentevent2(p0) 
	#define CHK_vishgetcurrentevent2  FALSE
	#define EXP_vishgetcurrentevent2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_vishgetcurrentevent2
	#define EXT_vishgetcurrentevent2
	#define GET_vishgetcurrentevent2(fl)  CAL_CMGETAPI( "vishgetcurrentevent2" ) 
	#define CAL_vishgetcurrentevent2  vishgetcurrentevent2
	#define CHK_vishgetcurrentevent2  TRUE
	#define EXP_vishgetcurrentevent2  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishgetcurrentevent2", (RTS_UINTPTR)vishgetcurrentevent2, 1, 0x78BEBA0E, 0x03050E00) 
#elif defined(MIXED_LINK) && !defined(CMPVISUHANDLER_EXTERNAL)
	#define USE_vishgetcurrentevent2
	#define EXT_vishgetcurrentevent2
	#define GET_vishgetcurrentevent2(fl)  CAL_CMGETAPI( "vishgetcurrentevent2" ) 
	...
	#define EXP_vishgetcurrentevent2  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishgetcurrentevent2", (RTS_UINTPTR)vishgetcurrentevent2, 1, 0x78BEBA0E, 0x03050E00) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpVisuHandlervishgetcurrentevent2
	#define EXT_CmpVisuHandlervishgetcurrentevent2
	#define GET_CmpVisuHandlervishgetcurrentevent2  ERR_OK
	#define CAL_CmpVisuHandlervishgetcurrentevent2  vishgetcurrentevent2
	#define CHK_CmpVisuHandlervishgetcurrentevent2  TRUE
	#define EXP_CmpVisuHandlervishgetcurrentevent2  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishgetcurrentevent2", (RTS_UINTPTR)vishgetcurrentevent2, 1, 0x78BEBA0E, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_vishgetcurrentevent2
	#define EXT_vishgetcurrentevent2
	#define GET_vishgetcurrentevent2(fl)  CAL_CMGETAPI( "vishgetcurrentevent2" ) 
	...
	#define EXP_vishgetcurrentevent2  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishgetcurrentevent2", (RTS_UINTPTR)vishgetcurrentevent2, 1, 0x78BEBA0E, 0x03050E00) 
#else /* DYNAMIC_LINK */
	#define USE_vishgetcurrentevent2  PFVISHGETCURRENTEVENT2_IEC pfvishgetcurrentevent2;
	#define EXT_vishgetcurrentevent2  extern PFVISHGETCURRENTEVENT2_IEC pfvishgetcurrentevent2;
	#define GET_vishgetcurrentevent2(fl)  s_pfCMGetAPI2( "vishgetcurrentevent2", (RTS_VOID_FCTPTR *)&pfvishgetcurrentevent2, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x78BEBA0E, 0x03050E00)
	#define CAL_vishgetcurrentevent2  pfvishgetcurrentevent2
	#define CHK_vishgetcurrentevent2  (pfvishgetcurrentevent2 != NULL)
	#define EXP_vishgetcurrentevent2   s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"vishgetcurrentevent2", (RTS_UINTPTR)vishgetcurrentevent2, 1, 0x78BEBA0E, 0x03050E00) 
#endif
 ...
 * the calls to GetPaintData.</result>
 */
int CDECL VishGetPaintData2(EventStruct2* pEvent, EventExtensionData* pOptExtensionData, CommandBuffer** pCmdsResult);
typedef int (CDECL * PFVISHGETPAINTDATA2) (EventStruct2* pEvent, EventExtensionData* pOptExtensionData, CommandBuffer** pCmdsResult);
#if defined(CMPVISUHANDLER_NOTIMPLEMENTED) || defined(VISHGETPAINTDATA2_NOTIMPLEMENTED)
	#define USE_VishGetPaintData2
	#define EXT_VishGetPaintData2
	#define GET_VishGetPaintData2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_VishGetPaintData2(p0,p1,p2) (int)ERR_NOTIMPLEMENTED
	#define CHK_VishGetPaintData2  FALSE
	#define EXP_VishGetPaintData2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_VishGetPaintData2
	#define EXT_VishGetPaintData2
	#define GET_VishGetPaintData2(fl)  CAL_CMGETAPI( "VishGetPaintData2" ) 
	#define CAL_VishGetPaintData2  VishGetPaintData2
	#define CHK_VishGetPaintData2  TRUE
	#define EXP_VishGetPaintData2  CAL_CMEXPAPI( "VishGetPaintData2" ) 
#elif defined(MIXED_LINK) && !defined(CMPVISUHANDLER_EXTERNAL)
	#define USE_VishGetPaintData2
	#define EXT_VishGetPaintData2
	#define GET_VishGetPaintData2(fl)  CAL_CMGETAPI( "VishGetPaintData2" ) 
	#define CAL_VishGetPaintData2  VishGetPaintData2
	#define CHK_VishGetPaintData2  TRUE
	#define EXP_VishGetPaintData2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishGetPaintData2", (RTS_UINTPTR)VishGetPaintData2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpVisuHandlerVishGetPaintData2
	#define EXT_CmpVisuHandlerVishGetPaintData2
	#define GET_CmpVisuHandlerVishGetPaintData2  ERR_OK
	#define CAL_CmpVisuHandlerVishGetPaintData2  VishGetPaintData2
	#define CHK_CmpVisuHandlerVishGetPaintData2  TRUE
	#define EXP_CmpVisuHandlerVishGetPaintData2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_VishGetPaintData2
	#define EXT_VishGetPaintData2
	#define GET_VishGetPaintData2(fl)  CAL_CMGETAPI( "VishGetPaintData2" ) 
	...
	#define EXP_VishGetPaintData2  CAL_CMEXPAPI( "VishGetPaintData2" ) 
#else /* DYNAMIC_LINK */
	#define USE_VishGetPaintData2  PFVISHGETPAINTDATA2 pfVishGetPaintData2;
	#define EXT_VishGetPaintData2  extern PFVISHGETPAINTDATA2 pfVishGetPaintData2;
	#define GET_VishGetPaintData2(fl)  s_pfCMGetAPI2( "VishGetPaintData2", (RTS_VOID_FCTPTR *)&pfVishGetPaintData2, (fl), 0, 0)
	#define CAL_VishGetPaintData2  pfVishGetPaintData2
	#define CHK_VishGetPaintData2  (pfVishGetPaintData2 != NULL)
	#define EXP_VishGetPaintData2   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishGetPaintData2", (RTS_UINTPTR)VishGetPaintData2, 0, 0) 
#endif
 ...
 * the calls to GetPaintData.</result>
 */
int CDECL VishPostEvent2(EventStruct2* pEvent, EventExtensionData* pOptExtensionData);
typedef int (CDECL * PFVISHPOSTEVENT2) (EventStruct2* pEvent, EventExtensionData* pOptExtensionData);
#if defined(CMPVISUHANDLER_NOTIMPLEMENTED) || defined(VISHPOSTEVENT2_NOTIMPLEMENTED)
	#define USE_VishPostEvent2
	#define EXT_VishPostEvent2
	#define GET_VishPostEvent2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_VishPostEvent2(p0,p1) (int)ERR_NOTIMPLEMENTED
	#define CHK_VishPostEvent2  FALSE
	#define EXP_VishPostEvent2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_VishPostEvent2
	#define EXT_VishPostEvent2
	#define GET_VishPostEvent2(fl)  CAL_CMGETAPI( "VishPostEvent2" ) 
	#define CAL_VishPostEvent2  VishPostEvent2
	#define CHK_VishPostEvent2  TRUE
	#define EXP_VishPostEvent2  CAL_CMEXPAPI( "VishPostEvent2" ) 
#elif defined(MIXED_LINK) && !defined(CMPVISUHANDLER_EXTERNAL)
	#define USE_VishPostEvent2
	#define EXT_VishPostEvent2
	#define GET_VishPostEvent2(fl)  CAL_CMGETAPI( "VishPostEvent2" ) 
	#define CAL_VishPostEvent2  VishPostEvent2
	#define CHK_VishPostEvent2  TRUE
	#define EXP_VishPostEvent2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishPostEvent2", (RTS_UINTPTR)VishPostEvent2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpVisuHandlerVishPostEvent2
	#define EXT_CmpVisuHandlerVishPostEvent2
	#define GET_CmpVisuHandlerVishPostEvent2  ERR_OK
	#define CAL_CmpVisuHandlerVishPostEvent2  VishPostEvent2
	#define CHK_CmpVisuHandlerVishPostEvent2  TRUE
	#define EXP_CmpVisuHandlerVishPostEvent2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_VishPostEvent2
	#define EXT_VishPostEvent2
	#define GET_VishPostEvent2(fl)  CAL_CMGETAPI( "VishPostEvent2" ) 
	...
	#define EXP_VishPostEvent2  CAL_CMEXPAPI( "VishPostEvent2" ) 
#else /* DYNAMIC_LINK */
	#define USE_VishPostEvent2  PFVISHPOSTEVENT2 pfVishPostEvent2;
	#define EXT_VishPostEvent2  extern PFVISHPOSTEVENT2 pfVishPostEvent2;
	#define GET_VishPostEvent2(fl)  s_pfCMGetAPI2( "VishPostEvent2", (RTS_VOID_FCTPTR *)&pfVishPostEvent2, (fl), 0, 0)
	#define CAL_VishPostEvent2  pfVishPostEvent2
	#define CHK_VishPostEvent2  (pfVishPostEvent2 != NULL)
	#define EXP_VishPostEvent2   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishPostEvent2", (RTS_UINTPTR)VishPostEvent2, 0, 0) 
#endif
...
/**
 * <description> Function initializes a Event instance with default values</description>
 */
 ...
 * <description> Function initializes a Event instance with default values</description>
 */
void CDECL VishInitEventStruct2(EventStruct2* pEvent);
typedef void (CDECL * PFVISHINITEVENTSTRUCT2) (EventStruct2* pEvent);
#if defined(CMPVISUHANDLER_NOTIMPLEMENTED) || defined(VISHINITEVENTSTRUCT2_NOTIMPLEMENTED)
	#define USE_VishInitEventStruct2
	#define EXT_VishInitEventStruct2
	#define GET_VishInitEventStruct2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_VishInitEventStruct2(p0) 
	#define CHK_VishInitEventStruct2  FALSE
	#define EXP_VishInitEventStruct2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_VishInitEventStruct2
	#define EXT_VishInitEventStruct2
	#define GET_VishInitEventStruct2(fl)  CAL_CMGETAPI( "VishInitEventStruct2" ) 
	#define CAL_VishInitEventStruct2  VishInitEventStruct2
	#define CHK_VishInitEventStruct2  TRUE
	#define EXP_VishInitEventStruct2  CAL_CMEXPAPI( "VishInitEventStruct2" ) 
#elif defined(MIXED_LINK) && !defined(CMPVISUHANDLER_EXTERNAL)
	#define USE_VishInitEventStruct2
	#define EXT_VishInitEventStruct2
	#define GET_VishInitEventStruct2(fl)  CAL_CMGETAPI( "VishInitEventStruct2" ) 
	#define CAL_VishInitEventStruct2  VishInitEventStruct2
	#define CHK_VishInitEventStruct2  TRUE
	#define EXP_VishInitEventStruct2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishInitEventStruct2", (RTS_UINTPTR)VishInitEventStruct2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpVisuHandlerVishInitEventStruct2
	#define EXT_CmpVisuHandlerVishInitEventStruct2
	#define GET_CmpVisuHandlerVishInitEventStruct2  ERR_OK
	#define CAL_CmpVisuHandlerVishInitEventStruct2  VishInitEventStruct2
	#define CHK_CmpVisuHandlerVishInitEventStruct2  TRUE
	#define EXP_CmpVisuHandlerVishInitEventStruct2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_VishInitEventStruct2
	#define EXT_VishInitEventStruct2
	#define GET_VishInitEventStruct2(fl)  CAL_CMGETAPI( "VishInitEventStruct2" ) 
	...
	#define EXP_VishInitEventStruct2  CAL_CMEXPAPI( "VishInitEventStruct2" ) 
#else /* DYNAMIC_LINK */
	#define USE_VishInitEventStruct2  PFVISHINITEVENTSTRUCT2 pfVishInitEventStruct2;
	#define EXT_VishInitEventStruct2  extern PFVISHINITEVENTSTRUCT2 pfVishInitEventStruct2;
	#define GET_VishInitEventStruct2(fl)  s_pfCMGetAPI2( "VishInitEventStruct2", (RTS_VOID_FCTPTR *)&pfVishInitEventStruct2, (fl), 0, 0)
	#define CAL_VishInitEventStruct2  pfVishInitEventStruct2
	#define CHK_VishInitEventStruct2  (pfVishInitEventStruct2 != NULL)
	#define EXP_VishInitEventStruct2   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"VishInitEventStruct2", (RTS_UINTPTR)VishInitEventStruct2, 0, 0) 
#endif
...
typedef RTS_UI32 (CDECL * PFVISHGETFILESTREAMINGCHUNKSIZE) (void);
