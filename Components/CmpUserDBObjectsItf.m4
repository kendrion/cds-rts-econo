 ...
 * <result>Handle to the object or RTS_INVALID_HANDLE if it could not be added</result>
 */
DEF_ITF_API(`RTS_HANDLE',`CDECL',`UserDBObjectAdd2',`(char *pszObject, RTS_UI32 properties, RTS_RESULT *pResult)') 
 ...
 * <result>Error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `UserDBObjectGetProperties', `(RTS_HANDLE hObject, RTS_UI32 *pulProperties)')
