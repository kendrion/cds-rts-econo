 ...
 * </result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `AppHasAddress2', `(APPLICATION* pApp, RTS_VOID_FCTPTR pAddress, RTS_BOOL bIncludeParents)')
 ...
 * <result>error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `AppCallGetProperty3', `(void *pInstance, RTS_VOID_FCTPTR *ppGetMethod, RTS_UI8 **ppbyValue, RTS_SIZE ulSize, RTS_SIZE ulOffset)')
 ...
 * <result>error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `AppCallSetProperty2', `(void *pInstance, RTS_VOID_FCTPTR *ppSetMethod, RTS_UI8 *pbyValue, RTS_SIZE ulSize, RTS_SIZE ulOffset)')
