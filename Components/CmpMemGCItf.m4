...
#endif
#if SYSMEM_IECAREA_BYTE_ALIGNMENT == 32 && (!defined(CMUTILSHASH_NOTIMPLEMENTED) && !defined(TRG_64BIT) || defined(CMUTILSHASH_NOTIMPLEMENTED) && defined(TRG_64BIT))
	RTS_UI8 _alignmentDummy[8];
#endif
	RTS_UI8 Mem;
} GARBAGE_COLLECTOR;
