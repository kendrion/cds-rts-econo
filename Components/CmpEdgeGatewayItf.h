...
#ifndef _CMPEDGEGATEWAYITF_H_
#define _CMPEDGEGATEWAYITF_H_
 ...
 */
RTS_RESULT CDECL EdgeGatewayHasFeature(RTS_UI32 ulFeatures);
typedef RTS_RESULT (CDECL * PFEDGEGATEWAYHASFEATURE) (RTS_UI32 ulFeatures);
#if defined(CMPEDGEGATEWAY_NOTIMPLEMENTED) || defined(EDGEGATEWAYHASFEATURE_NOTIMPLEMENTED)
	#define USE_EdgeGatewayHasFeature
	#define EXT_EdgeGatewayHasFeature
	#define GET_EdgeGatewayHasFeature(fl)  ERR_NOTIMPLEMENTED
	#define CAL_EdgeGatewayHasFeature(p0)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_EdgeGatewayHasFeature  FALSE
	#define EXP_EdgeGatewayHasFeature  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_EdgeGatewayHasFeature
	#define EXT_EdgeGatewayHasFeature
	#define GET_EdgeGatewayHasFeature(fl)  CAL_CMGETAPI( "EdgeGatewayHasFeature" ) 
	#define CAL_EdgeGatewayHasFeature  EdgeGatewayHasFeature
	#define CHK_EdgeGatewayHasFeature  TRUE
	#define EXP_EdgeGatewayHasFeature  CAL_CMEXPAPI( "EdgeGatewayHasFeature" ) 
#elif defined(MIXED_LINK) && !defined(CMPEDGEGATEWAY_EXTERNAL)
	#define USE_EdgeGatewayHasFeature
	#define EXT_EdgeGatewayHasFeature
	#define GET_EdgeGatewayHasFeature(fl)  CAL_CMGETAPI( "EdgeGatewayHasFeature" ) 
	#define CAL_EdgeGatewayHasFeature  EdgeGatewayHasFeature
	#define CHK_EdgeGatewayHasFeature  TRUE
	#define EXP_EdgeGatewayHasFeature  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"EdgeGatewayHasFeature", (RTS_UINTPTR)EdgeGatewayHasFeature, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpEdgeGatewayEdgeGatewayHasFeature
	#define EXT_CmpEdgeGatewayEdgeGatewayHasFeature
	#define GET_CmpEdgeGatewayEdgeGatewayHasFeature  ERR_OK
	#define CAL_CmpEdgeGatewayEdgeGatewayHasFeature pICmpEdgeGateway->IEdgeGatewayHasFeature
	#define CHK_CmpEdgeGatewayEdgeGatewayHasFeature (pICmpEdgeGateway != NULL)
	#define EXP_CmpEdgeGatewayEdgeGatewayHasFeature  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_EdgeGatewayHasFeature
	#define EXT_EdgeGatewayHasFeature
	#define GET_EdgeGatewayHasFeature(fl)  CAL_CMGETAPI( "EdgeGatewayHasFeature" ) 
	#define CAL_EdgeGatewayHasFeature pICmpEdgeGateway->IEdgeGatewayHasFeature
	#define CHK_EdgeGatewayHasFeature (pICmpEdgeGateway != NULL)
	#define EXP_EdgeGatewayHasFeature  CAL_CMEXPAPI( "EdgeGatewayHasFeature" ) 
#else /* DYNAMIC_LINK */
	#define USE_EdgeGatewayHasFeature  PFEDGEGATEWAYHASFEATURE pfEdgeGatewayHasFeature;
	#define EXT_EdgeGatewayHasFeature  extern PFEDGEGATEWAYHASFEATURE pfEdgeGatewayHasFeature;
	#define GET_EdgeGatewayHasFeature(fl)  s_pfCMGetAPI2( "EdgeGatewayHasFeature", (RTS_VOID_FCTPTR *)&pfEdgeGatewayHasFeature, (fl), 0, 0)
	#define CAL_EdgeGatewayHasFeature  pfEdgeGatewayHasFeature
	#define CHK_EdgeGatewayHasFeature  (pfEdgeGatewayHasFeature != NULL)
	#define EXP_EdgeGatewayHasFeature  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"EdgeGatewayHasFeature", (RTS_UINTPTR)EdgeGatewayHasFeature, 0, 0) 
#endif
...
{
	IBase_C *pBase;
	PFEDGEGATEWAYHASFEATURE IEdgeGatewayHasFeature;
 } ICmpEdgeGateway_C;

#ifdef CPLUSPLUS
class ICmpEdgeGateway : public IBase
{
	public:
		virtual RTS_RESULT CDECL IEdgeGatewayHasFeature(RTS_UI32 ulFeatures) =0;
};
	#ifndef ITF_CmpEdgeGateway
		#define ITF_CmpEdgeGateway static ICmpEdgeGateway *pICmpEdgeGateway = NULL;
	#endif
	#define EXTITF_CmpEdgeGateway
#else	/*CPLUSPLUS*/
	typedef ICmpEdgeGateway_C		ICmpEdgeGateway;
	#ifndef ITF_CmpEdgeGateway
		#define ITF_CmpEdgeGateway
	#endif
	#define EXTITF_CmpEdgeGateway
#endif
