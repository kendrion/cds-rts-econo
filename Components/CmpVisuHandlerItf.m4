...
DEF_API(`void',`CDECL',`vishconfigureeventbuffer',`(vishconfigureeventbuffer_struct *p)',1,0x44C4FEA3,0x03050E00)
...
DEF_API(`void',`CDECL',`vishgetcurrentevent2',`(vishgetcurrentevent2_struct *p)',1,0x78BEBA0E,0x03050E00)
 ...
 * the calls to GetPaintData.</result>
 */
DEF_API(`int', `CDECL', `VishGetPaintData2', `(EventStruct2* pEvent, EventExtensionData* pOptExtensionData, CommandBuffer** pCmdsResult)')
 ...
 * the calls to GetPaintData.</result>
 */
DEF_API(`int', `CDECL', `VishPostEvent2', `(EventStruct2* pEvent, EventExtensionData* pOptExtensionData)')
 ...
 * <description> Function initializes a Event instance with default values</description>
 */
DEF_API(`void', `CDECL', `VishInitEventStruct2', `(EventStruct2* pEvent)')
