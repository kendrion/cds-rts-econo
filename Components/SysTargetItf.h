...
/**
* <category>Events</category>
* <description>Event is sent in function SysTargetSetNodeName() after the new node 
* name is stored in the settings. 
* The return parameter EVTPARAM_SysEvent_SetNodeName.rResult is irrelevant here!
* </description>
* <param name="pEventParam" type="IN">EVTPARAM_SysEvent_SetNodeName</param>
*/
#define EVT_SysTarget_SetNodeNameDone		MAKE_EVENTID(EVTCLASS_INFO, 2)
