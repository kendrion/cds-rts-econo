 ...
 * <description>These defines are used as properties of the UserDB Objects. Use as Bitmask.</description>
 ...
 * <result>Handle to the object or RTS_INVALID_HANDLE if it could not be added</result>
 */
RTS_HANDLE CDECL UserDBObjectAdd2(char *pszObject, RTS_UI32 properties, RTS_RESULT *pResult);
typedef RTS_HANDLE (CDECL * PFUSERDBOBJECTADD2) (char *pszObject, RTS_UI32 properties, RTS_RESULT *pResult);
#if defined(CMPUSERDBOBJECTS_NOTIMPLEMENTED) || defined(USERDBOBJECTADD2_NOTIMPLEMENTED)
	#define USE_UserDBObjectAdd2
	#define EXT_UserDBObjectAdd2
	#define GET_UserDBObjectAdd2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_UserDBObjectAdd2(p0,p1,p2)  (RTS_HANDLE)RTS_INVALID_HANDLE
	#define CHK_UserDBObjectAdd2  FALSE
	#define EXP_UserDBObjectAdd2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_UserDBObjectAdd2
	#define EXT_UserDBObjectAdd2
	#define GET_UserDBObjectAdd2(fl)  CAL_CMGETAPI( "UserDBObjectAdd2" ) 
	#define CAL_UserDBObjectAdd2  UserDBObjectAdd2
	#define CHK_UserDBObjectAdd2  TRUE
	#define EXP_UserDBObjectAdd2  CAL_CMEXPAPI( "UserDBObjectAdd2" ) 
#elif defined(MIXED_LINK) && !defined(CMPUSERDBOBJECTS_EXTERNAL)
	#define USE_UserDBObjectAdd2
	#define EXT_UserDBObjectAdd2
	#define GET_UserDBObjectAdd2(fl)  CAL_CMGETAPI( "UserDBObjectAdd2" ) 
	#define CAL_UserDBObjectAdd2  UserDBObjectAdd2
	#define CHK_UserDBObjectAdd2  TRUE
	#define EXP_UserDBObjectAdd2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"UserDBObjectAdd2", (RTS_UINTPTR)UserDBObjectAdd2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpUserDBObjectsUserDBObjectAdd2
	#define EXT_CmpUserDBObjectsUserDBObjectAdd2
	#define GET_CmpUserDBObjectsUserDBObjectAdd2  ERR_OK
	#define CAL_CmpUserDBObjectsUserDBObjectAdd2 pICmpUserDBObjects->IUserDBObjectAdd2
	#define CHK_CmpUserDBObjectsUserDBObjectAdd2 (pICmpUserDBObjects != NULL)
	#define EXP_CmpUserDBObjectsUserDBObjectAdd2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_UserDBObjectAdd2
	#define EXT_UserDBObjectAdd2
	#define GET_UserDBObjectAdd2(fl)  CAL_CMGETAPI( "UserDBObjectAdd2" ) 
	#define CAL_UserDBObjectAdd2 pICmpUserDBObjects->IUserDBObjectAdd2
	#define CHK_UserDBObjectAdd2 (pICmpUserDBObjects != NULL)
	#define EXP_UserDBObjectAdd2  CAL_CMEXPAPI( "UserDBObjectAdd2" ) 
#else /* DYNAMIC_LINK */
	#define USE_UserDBObjectAdd2  PFUSERDBOBJECTADD2 pfUserDBObjectAdd2;
	#define EXT_UserDBObjectAdd2  extern PFUSERDBOBJECTADD2 pfUserDBObjectAdd2;
	#define GET_UserDBObjectAdd2(fl)  s_pfCMGetAPI2( "UserDBObjectAdd2", (RTS_VOID_FCTPTR *)&pfUserDBObjectAdd2, (fl), 0, 0)
	#define CAL_UserDBObjectAdd2  pfUserDBObjectAdd2
	#define CHK_UserDBObjectAdd2  (pfUserDBObjectAdd2 != NULL)
	#define EXP_UserDBObjectAdd2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"UserDBObjectAdd2", (RTS_UINTPTR)UserDBObjectAdd2, 0, 0) 
#endif
 ...
 * <result>Error code</result>
 */
RTS_RESULT CDECL UserDBObjectGetProperties(RTS_HANDLE hObject, RTS_UI32 *pulProperties);
typedef RTS_RESULT (CDECL * PFUSERDBOBJECTGETPROPERTIES) (RTS_HANDLE hObject, RTS_UI32 *pulProperties);
#if defined(CMPUSERDBOBJECTS_NOTIMPLEMENTED) || defined(USERDBOBJECTGETPROPERTIES_NOTIMPLEMENTED)
	#define USE_UserDBObjectGetProperties
	#define EXT_UserDBObjectGetProperties
	#define GET_UserDBObjectGetProperties(fl)  ERR_NOTIMPLEMENTED
	#define CAL_UserDBObjectGetProperties(p0,p1)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_UserDBObjectGetProperties  FALSE
	#define EXP_UserDBObjectGetProperties  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_UserDBObjectGetProperties
	#define EXT_UserDBObjectGetProperties
	#define GET_UserDBObjectGetProperties(fl)  CAL_CMGETAPI( "UserDBObjectGetProperties" ) 
	#define CAL_UserDBObjectGetProperties  UserDBObjectGetProperties
	#define CHK_UserDBObjectGetProperties  TRUE
	#define EXP_UserDBObjectGetProperties  CAL_CMEXPAPI( "UserDBObjectGetProperties" ) 
#elif defined(MIXED_LINK) && !defined(CMPUSERDBOBJECTS_EXTERNAL)
	#define USE_UserDBObjectGetProperties
	#define EXT_UserDBObjectGetProperties
	#define GET_UserDBObjectGetProperties(fl)  CAL_CMGETAPI( "UserDBObjectGetProperties" ) 
	#define CAL_UserDBObjectGetProperties  UserDBObjectGetProperties
	#define CHK_UserDBObjectGetProperties  TRUE
	#define EXP_UserDBObjectGetProperties  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"UserDBObjectGetProperties", (RTS_UINTPTR)UserDBObjectGetProperties, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpUserDBObjectsUserDBObjectGetProperties
	#define EXT_CmpUserDBObjectsUserDBObjectGetProperties
	#define GET_CmpUserDBObjectsUserDBObjectGetProperties  ERR_OK
	#define CAL_CmpUserDBObjectsUserDBObjectGetProperties pICmpUserDBObjects->IUserDBObjectGetProperties
	#define CHK_CmpUserDBObjectsUserDBObjectGetProperties (pICmpUserDBObjects != NULL)
	#define EXP_CmpUserDBObjectsUserDBObjectGetProperties  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_UserDBObjectGetProperties
	#define EXT_UserDBObjectGetProperties
	#define GET_UserDBObjectGetProperties(fl)  CAL_CMGETAPI( "UserDBObjectGetProperties" ) 
	#define CAL_UserDBObjectGetProperties pICmpUserDBObjects->IUserDBObjectGetProperties
	#define CHK_UserDBObjectGetProperties (pICmpUserDBObjects != NULL)
	#define EXP_UserDBObjectGetProperties  CAL_CMEXPAPI( "UserDBObjectGetProperties" ) 
#else /* DYNAMIC_LINK */
	#define USE_UserDBObjectGetProperties  PFUSERDBOBJECTGETPROPERTIES pfUserDBObjectGetProperties;
	#define EXT_UserDBObjectGetProperties  extern PFUSERDBOBJECTGETPROPERTIES pfUserDBObjectGetProperties;
	#define GET_UserDBObjectGetProperties(fl)  s_pfCMGetAPI2( "UserDBObjectGetProperties", (RTS_VOID_FCTPTR *)&pfUserDBObjectGetProperties, (fl), 0, 0)
	#define CAL_UserDBObjectGetProperties  pfUserDBObjectGetProperties
	#define CHK_UserDBObjectGetProperties  (pfUserDBObjectGetProperties != NULL)
	#define EXP_UserDBObjectGetProperties  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"UserDBObjectGetProperties", (RTS_UINTPTR)UserDBObjectGetProperties, 0, 0) 
#endif
...
typedef struct
{
	...
	PFUSERDBRIGHTSLOAD IUserDBRightsLoad;
 	...
 	PFUSERDBOBJECTADD2 IUserDBObjectAdd2;
 	...
 	PFUSERDBOBJECTGETPROPERTIES IUserDBObjectGetProperties;
...
class ICmpUserDBObjects : public IBase
{
	public:
		...
		virtual RTS_HANDLE CDECL IUserDBObjectAdd2(char *pszObject, RTS_UI32 properties, RTS_RESULT *pResult) =0;
		...
		virtual RTS_RESULT CDECL IUserDBObjectGetProperties(RTS_HANDLE hObject, RTS_UI32 *pulProperties) =0;
