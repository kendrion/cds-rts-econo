 ...
 *
		// Allocate a new MemPool block must be done in 2 steps:
 *		// Step1: Get handle/Allocate new block out of the MemPool (instead of CAL_MemPoolGetBlock())!
 ...
 * </description>
 * <param name="hMemPool" type="IN">Handle to the memory pool created by MemPoolCreateDynamic / MemPoolCreateStatic</param>
 ...
 * <result>Handle to the create hash table around the memory pool specified by hMemPool</result>
 */
 ...
 * </description>
 * <param name="hMemPool" type="IN">Handle to the memory pool created by MemPoolCreateDynamic / MemPoolCreateStatic</param>
 * <param name="sNumHashEntries" type="IN">Number of blocks that are managed in the hash table</param> 
 ...
 * </description>
 * <param name="hMemPool" type="IN">Handle to the memory pool created by MemPoolCreateDynamic / MemPoolCreateStatic</param>
 * <param name="nNumOfNewElements" type="IN">Number of new elements to extend in the underlying memory  pool to get the new memory block</param> 
 * <param name="pResult" type="OUT">Pointer to error code</param>
 * <errorcode name="RTS_RESULT pResult" type="ERR_OK">New hashed memory pool block can be retrieved</errorcode>
 * <errorcode name="RTS_RESULT Result" type="ERR_PARAMETER">Invalid hash table handle</errorcode> 
 * <errorcode name="RTS_RESULT pResult" type="ERR_NOMEMORY">There is no more memory left to get the hashed memory pool block</errorcode>
 * <result>Handle to the new memory pool block</result>
 */
 ...
 * </description>
 * <param name="hMemPool" type="IN">Handle to the memory  pool created by MemPoolCreateDynamic / MemPoolCreateStatic</param>
 * <param name="hHash" type="IN">Handle to the hashed memory pool object retrieved by MemPoolGetBlockHashed() or MemPoolGetBlockHashed2()</param> 
 * <errorcode name="RTS_RESULT Result" type="ERR_OK">Hashed memory pool object could be removed</errorcode>
 * <errorcode name="RTS_RESULT Result" type="ERR_PARAMETER">Invalid hash table handle or hash memory pool object</errorcode> 
 * <errorcode name="RTS_RESULT Result" type="ERR_FAILED">Hashed memory pool object failed to remove</errorcode> 
 * <result>error code</result>
 */
 ...
 * <result>Pointer to the data of the hashed memory pool object</result>
 */
