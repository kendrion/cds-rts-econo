 ...
 */
DEF_ITF_API(`RTS_HANDLE',`CDECL',`SysMCFindTaskGroup',`(char *pszTaskGroup, RTS_I32 bIecTaskGroup, RTS_RESULT *pResult)')
 ...
 * <errorcode name="RTS_RESULT" type="ERR_INVALID_HANDLE">The given handle is invalid.</errorcode>
 */
DEF_ITF_API(`RTS_RESULT',`CDECL',`SysMCChangeTaskGroupStrategy',`(RTS_HANDLE hTaskGroup, RTS_UI32 taskGroupStrategy)')
