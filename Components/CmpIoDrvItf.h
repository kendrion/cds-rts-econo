 ...
 *		In this case, the driver can cleanup its configuration, stop the bus etc.
 * </param> 
 ...
 *
 *	NOTE:
 *		The function is called with pTaskMapList = NULL to signalize the driver, that the IO-configuration will be deleted because of an exception in a IoDrvUpdateMapping() of a driver!!
 *		In this case, the driver has to cleanup its stored mapping table!
