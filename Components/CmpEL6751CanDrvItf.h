...
typedef void (CDECL CDECL_EXT* PFEL6751_AFTERREADINPUTS_IEC) (el6751_afterreadinputs_struct *p);
	...
	#define EXP_el6751_afterreadinputs  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_afterreadinputs", (RTS_UINTPTR)el6751_afterreadinputs, 1, 0x0D252201, 0x03050E00) 
	...
	#define EXP_CmpEL6751CanDrvel6751_afterreadinputs  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_afterreadinputs", (RTS_UINTPTR)el6751_afterreadinputs, 1, 0x0D252201, 0x03050E00) 
	...
	#define GET_el6751_afterreadinputs(fl)  s_pfCMGetAPI2( "el6751_afterreadinputs", (RTS_VOID_FCTPTR *)&pfel6751_afterreadinputs, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x0D252201, 0x03050E00)
...
typedef void (CDECL CDECL_EXT* PFEL6751_BEFOREWRITEOUTPUTS_IEC) (el6751_beforewriteoutputs_struct *p);
	...
	#define EXP_el6751_beforewriteoutputs  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_beforewriteoutputs", (RTS_UINTPTR)el6751_beforewriteoutputs, 1, 0x76DBEC2D, 0x03050E00) 
#elif defined(MIXED_LINK) && !defined(CMPEL6751CANDRV_EXTERNAL)
	#define USE_el6751_beforewriteoutputs
	#define EXT_el6751_beforewriteoutputs
	#define GET_el6751_beforewriteoutputs(fl)  CAL_CMGETAPI( "el6751_beforewriteoutputs" ) 
	...
	#define EXP_CmpEL6751CanDrvel6751_beforewriteoutputs  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_beforewriteoutputs", (RTS_UINTPTR)el6751_beforewriteoutputs, 1, 0x76DBEC2D, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_el6751_beforewriteoutputs
	#define EXT_el6751_beforewriteoutputs
	#define GET_el6751_beforewriteoutputs(fl)  CAL_CMGETAPI( "el6751_beforewriteoutputs" ) 
	...
	#define GET_el6751_beforewriteoutputs(fl)  s_pfCMGetAPI2( "el6751_beforewriteoutputs", (RTS_VOID_FCTPTR *)&pfel6751_beforewriteoutputs, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x76DBEC2D, 0x03050E00)
...
typedef void (CDECL CDECL_EXT* PFEL6751_KILLCMD_IEC) (el6751_killcmd_struct *p);
	...
	#define EXP_el6751_killcmd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_killcmd", (RTS_UINTPTR)el6751_killcmd, 1, 0xD3AA0B37, 0x03050E00) 
#elif defined(MIXED_LINK) && !defined(CMPEL6751CANDRV_EXTERNAL)
	#define USE_el6751_killcmd
	#define EXT_el6751_killcmd
	#define GET_el6751_killcmd(fl)  CAL_CMGETAPI( "el6751_killcmd" ) 
	...
	#define EXP_CmpEL6751CanDrvel6751_killcmd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_killcmd", (RTS_UINTPTR)el6751_killcmd, 1, 0xD3AA0B37, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_el6751_killcmd
	#define EXT_el6751_killcmd
	#define GET_el6751_killcmd(fl)  CAL_CMGETAPI( "el6751_killcmd" ) 
	...
	#define GET_el6751_killcmd(fl)  s_pfCMGetAPI2( "el6751_killcmd", (RTS_VOID_FCTPTR *)&pfel6751_killcmd, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xD3AA0B37, 0x03050E00)
...
typedef void (CDECL CDECL_EXT* PFEL6751_REGISTERCMD_IEC) (el6751_registercmd_struct *p);
	...
	#define EXP_el6751_registercmd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_registercmd", (RTS_UINTPTR)el6751_registercmd, 1, 0x1E6CBB59, 0x03050E00) 
#elif defined(MIXED_LINK) && !defined(CMPEL6751CANDRV_EXTERNAL)
	#define USE_el6751_registercmd
	#define EXT_el6751_registercmd
	#define GET_el6751_registercmd(fl)  CAL_CMGETAPI( "el6751_registercmd" ) 
	...
	#define EXP_CmpEL6751CanDrvel6751_registercmd  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"el6751_registercmd", (RTS_UINTPTR)el6751_registercmd, 1, 0x1E6CBB59, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_el6751_registercmd
	#define EXT_el6751_registercmd
	#define GET_el6751_registercmd(fl)  CAL_CMGETAPI( "el6751_registercmd" ) 
	...
	#define GET_el6751_registercmd(fl)  s_pfCMGetAPI2( "el6751_registercmd", (RTS_VOID_FCTPTR *)&pfel6751_registercmd, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0x1E6CBB59, 0x03050E00)
