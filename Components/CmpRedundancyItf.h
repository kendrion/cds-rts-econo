...
void CDECL CDECL_EXT getplcident(getplcident_struct *p);
typedef void (CDECL CDECL_EXT* PFGETPLCIDENT_IEC) (getplcident_struct *p);
#if defined(CMPREDUNDANCY_NOTIMPLEMENTED) || defined(GETPLCIDENT_NOTIMPLEMENTED)
	#define USE_getplcident
	#define EXT_getplcident
	#define GET_getplcident(fl)  ERR_NOTIMPLEMENTED
	#define CAL_getplcident(p0) 
	#define CHK_getplcident  FALSE
	#define EXP_getplcident  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_getplcident
	#define EXT_getplcident
	#define GET_getplcident(fl)  CAL_CMGETAPI( "getplcident" ) 
	#define CAL_getplcident  getplcident
	#define CHK_getplcident  TRUE
	...
	#define EXP_getplcident  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"getplcident", (RTS_UINTPTR)getplcident, 1, 0xE8999A90, 0x03050E00) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpRedundancygetplcident
	#define EXT_CmpRedundancygetplcident
	#define GET_CmpRedundancygetplcident  ERR_OK
	#define CAL_CmpRedundancygetplcident  getplcident
	#define CHK_CmpRedundancygetplcident  TRUE
	#define EXP_CmpRedundancygetplcident  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"getplcident", (RTS_UINTPTR)getplcident, 1, 0xE8999A90, 0x03050E00) 
#elif defined(CPLUSPLUS)
	#define USE_getplcident
	#define EXT_getplcident
	#define GET_getplcident(fl)  CAL_CMGETAPI( "getplcident" ) 
	...
	#define EXP_getplcident  s_pfCMRegisterAPI2( (const CMP_EXT_FUNCTION_REF*)"getplcident", (RTS_UINTPTR)getplcident, 1, 0xE8999A90, 0x03050E00) 
#else /* DYNAMIC_LINK */
	#define USE_getplcident  PFGETPLCIDENT_IEC pfgetplcident;
	#define EXT_getplcident  extern PFGETPLCIDENT_IEC pfgetplcident;
	#define GET_getplcident(fl)  s_pfCMGetAPI2( "getplcident", (RTS_VOID_FCTPTR *)&pfgetplcident, (fl) | CM_IMPORT_EXTERNAL_LIB_FUNCTION, 0xE8999A90, 0x03050E00)
	#define CAL_getplcident  pfgetplcident
