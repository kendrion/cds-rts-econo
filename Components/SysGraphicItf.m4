 ...
 * <result>error code</result>
 */
DEF_API(`RTS_RESULT',`CDECL',`SysGraphicSetRoundRectRadius',`(RTS_HANDLE hDC, RTS_I16 iRadiusX, RTS_I16 iRadiusY)')
 ...
 * <result>An error code</result>
*/
DEF_ITF_API(`RTS_RESULT',`CDECL',`SysGraphicSetCompositingMode',`(RTS_HANDLE hDC, RTS_UI32 compositingMode)')
 ...
 * <result>An error code</result>
*/
DEF_ITF_API(`RTS_UI32',`CDECL',`SysGraphicGetCompositingMode',`(RTS_HANDLE hDC, RTS_RESULT* pResult)')
