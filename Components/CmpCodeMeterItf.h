 ...
 * </result>
 */
RTS_RESULT CDECL CodeMGetContentByFirmcode3(RTS_UI32 ulFirmcode, RTS_UI32 ulProductcode, RTS_BOOL bReleaseLicense, RTS_CMBOXENTRY *paEntry);
typedef RTS_RESULT (CDECL * PFCODEMGETCONTENTBYFIRMCODE3) (RTS_UI32 ulFirmcode, RTS_UI32 ulProductcode, RTS_BOOL bReleaseLicense, RTS_CMBOXENTRY *paEntry);
#if defined(CMPCODEMETER_NOTIMPLEMENTED) || defined(CODEMGETCONTENTBYFIRMCODE3_NOTIMPLEMENTED)
	#define USE_CodeMGetContentByFirmcode3
	#define EXT_CodeMGetContentByFirmcode3
	#define GET_CodeMGetContentByFirmcode3(fl)  ERR_NOTIMPLEMENTED
	#define CAL_CodeMGetContentByFirmcode3(p0,p1,p2,p3)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_CodeMGetContentByFirmcode3  FALSE
	#define EXP_CodeMGetContentByFirmcode3  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_CodeMGetContentByFirmcode3
	#define EXT_CodeMGetContentByFirmcode3
	#define GET_CodeMGetContentByFirmcode3(fl)  CAL_CMGETAPI( "CodeMGetContentByFirmcode3" ) 
	#define CAL_CodeMGetContentByFirmcode3  CodeMGetContentByFirmcode3
	#define CHK_CodeMGetContentByFirmcode3  TRUE
	#define EXP_CodeMGetContentByFirmcode3  CAL_CMEXPAPI( "CodeMGetContentByFirmcode3" ) 
#elif defined(MIXED_LINK) && !defined(CMPCODEMETER_EXTERNAL)
	#define USE_CodeMGetContentByFirmcode3
	#define EXT_CodeMGetContentByFirmcode3
	#define GET_CodeMGetContentByFirmcode3(fl)  CAL_CMGETAPI( "CodeMGetContentByFirmcode3" ) 
	#define CAL_CodeMGetContentByFirmcode3  CodeMGetContentByFirmcode3
	#define CHK_CodeMGetContentByFirmcode3  TRUE
	#define EXP_CodeMGetContentByFirmcode3  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CodeMGetContentByFirmcode3", (RTS_UINTPTR)CodeMGetContentByFirmcode3, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpCodeMeterCodeMGetContentByFirmcode3
	#define EXT_CmpCodeMeterCodeMGetContentByFirmcode3
	#define GET_CmpCodeMeterCodeMGetContentByFirmcode3  ERR_OK
	#define CAL_CmpCodeMeterCodeMGetContentByFirmcode3 pICmpCodeMeter->ICodeMGetContentByFirmcode3
	#define CHK_CmpCodeMeterCodeMGetContentByFirmcode3 (pICmpCodeMeter != NULL)
	#define EXP_CmpCodeMeterCodeMGetContentByFirmcode3  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_CodeMGetContentByFirmcode3
	#define EXT_CodeMGetContentByFirmcode3
	#define GET_CodeMGetContentByFirmcode3(fl)  CAL_CMGETAPI( "CodeMGetContentByFirmcode3" ) 
	#define CAL_CodeMGetContentByFirmcode3 pICmpCodeMeter->ICodeMGetContentByFirmcode3
	#define CHK_CodeMGetContentByFirmcode3 (pICmpCodeMeter != NULL)
	#define EXP_CodeMGetContentByFirmcode3  CAL_CMEXPAPI( "CodeMGetContentByFirmcode3" ) 
#else /* DYNAMIC_LINK */
	#define USE_CodeMGetContentByFirmcode3  PFCODEMGETCONTENTBYFIRMCODE3 pfCodeMGetContentByFirmcode3;
	#define EXT_CodeMGetContentByFirmcode3  extern PFCODEMGETCONTENTBYFIRMCODE3 pfCodeMGetContentByFirmcode3;
	#define GET_CodeMGetContentByFirmcode3(fl)  s_pfCMGetAPI2( "CodeMGetContentByFirmcode3", (RTS_VOID_FCTPTR *)&pfCodeMGetContentByFirmcode3, (fl), 0, 0)
	#define CAL_CodeMGetContentByFirmcode3  pfCodeMGetContentByFirmcode3
	#define CHK_CodeMGetContentByFirmcode3  (pfCodeMGetContentByFirmcode3 != NULL)
	#define EXP_CodeMGetContentByFirmcode3  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CodeMGetContentByFirmcode3", (RTS_UINTPTR)CodeMGetContentByFirmcode3, 0, 0) 
#endif
...
typedef struct
{
	...
	PFCODEMGETFIRST ICodeMGetFirst;
 	...
 	PFCODEMGETCONTENTBYFIRMCODE3 ICodeMGetContentByFirmcode3;
...
class ICmpCodeMeter : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL ICodeMGetContentByFirmcode3(RTS_UI32 ulFirmcode, RTS_UI32 ulProductcode, RTS_BOOL bReleaseLicense, RTS_CMBOXENTRY *paEntry) =0;
