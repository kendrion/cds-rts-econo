...
DEF_API(`void',`CDECL',`syssockaccept',`(syssockaccept_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xCA6B3076),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockbind',`(syssockbind_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xCF23D531),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockclose',`(syssockclose_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xF72471AA),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockcloseudp',`(syssockcloseudp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x6978E3CC),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockconnect',`(syssockconnect_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x765FD3AB),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockcreate',`(syssockcreate_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xE8829CB3),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockcreateudp',`(syssockcreateudp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x4A894324),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockfdinit',`(syssockfdinit_struct *p)',1,0x09C72D7D,0x03050E00)
...
DEF_API(`void',`CDECL',`syssockfdisset',`(syssockfdisset_struct *p)',1,0x25248CA6,0x03050E00)
...
DEF_API(`void',`CDECL',`syssockfdzero',`(syssockfdzero_struct *p)',1,0xD6D9FDA1,0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetfirstadapterinfo',`(syssockgetfirstadapterinfo_struct *p)',1,RTSITF_GET_SIGNATURE(0x0FE33BC1, 0xF08189B5),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgethostbyname',`(syssockgethostbyname_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x05667F90),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgethostname',`(syssockgethostname_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x68CAC03B),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetnextadapterinfo',`(syssockgetnextadapterinfo_struct *p)',1,RTSITF_GET_SIGNATURE(0x1BE45D9D, 0x8EB7E5E3),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetoption',`(syssockgetoption_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xB7ABC5B8),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetoshandle',`(syssockgetoshandle_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x784811EB),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetpeername',`(syssockgetpeername_struct *p)',1,0xE0A45F4A,0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetrecvsizeudp',`(syssockgetrecvsizeudp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xDBEEF58B),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetsockname',`(syssockgetsockname_struct *p)',1,0x7EE86135,0x03050E00)
...
DEF_API(`void',`CDECL',`syssockgetsubnetmask',`(syssockgetsubnetmask_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x972C29B9),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockhtonl',`(syssockhtonl_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x72F6021A),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockhtons',`(syssockhtons_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xD258956A),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockinetaddr',`(syssockinetaddr_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xB8198B8F),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockinetntoa',`(syssockinetntoa_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x5CE722B2),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockioctl',`(syssockioctl_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x408480FB),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocklisten',`(syssocklisten_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x30FE27C1),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockntohl',`(syssockntohl_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x05B31DF1),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockntohs',`(syssockntohs_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x100E0417),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockping',`(syssockping_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xB3610A39),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockrecv',`(syssockrecv_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x887FBA6B),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockrecvfrom',`(syssockrecvfrom_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x26DF0362),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockrecvfromudp',`(syssockrecvfromudp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x86A63EF8),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockrecvfromudp2',`(syssockrecvfromudp2_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xBA3470D3),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockselect',`(syssockselect_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x59125CA7),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksend',`(syssocksend_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xA73C5F51),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksendto',`(syssocksendto_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xEE37CAFA),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksendtoudp',`(syssocksendtoudp_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x81DCE32E),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksetdefaultgateway',`(syssocksetdefaultgateway_struct *p)',1,0xB87B1303,0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksetipaddress',`(syssocksetipaddress_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x955CE64B),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksetipaddressandnetmask',`(syssocksetipaddressandnetmask_struct *p)',1,0x01D16C55,0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksetoption',`(syssocksetoption_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xFBCD9B23),0x03050E00)
...
DEF_API(`void',`CDECL',`syssocksetsubnetmask',`(syssocksetsubnetmask_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0x0185BC67),0x03050E00)
...
DEF_API(`void',`CDECL',`syssockshutdown',`(syssockshutdown_struct *p)',1,RTSITF_GET_SIGNATURE(0, 0xCB0E612E),0x03050E00)
