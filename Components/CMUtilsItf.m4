...
#define CM_STRING_GET_CONTENT(string)					CM_PSTRING_GET_CONTENT(&string, NULL)
 ...
 * <result>error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `CMStringDelete', `(RTS_STRING_CLASS *pString)')
 ...
 * <result>error code</result>
 */
DEF_ITF_API(`RTS_RESULT', `CDECL', `CMStringExtend', `(RTS_STRING_CLASS *pString, RTS_SIZE size)')
