 ...
 *	Only for internal use in the runtime system!! Don't use it in adaptations!
 * </description>
 * <param name="pbp" type="IN">Pointer to breakpoint retrieved by AppBPSet() or AppBPGetFirst/AppBPGetNext</param>
 * <param name="bRestoreCode" type="IN">TRUE=Restore original code before deleting the breakpoint; FALSE=Don't restore original code before deleting the breakpoint</param>
 * <param name="bInIecTask" type="IN">TRUE=The caller is an IEC task and so we cannot synchronize against IEC tasks!; FALSE=The caller is no IEC task</param>
 * <result>error code</result>
 */
RTS_RESULT CDECL AppBPDelete2(Breakpoint *pbp, RTS_BOOL bRestoreCode, RTS_BOOL bInIecTask);
typedef RTS_RESULT (CDECL * PFAPPBPDELETE2) (Breakpoint *pbp, RTS_BOOL bRestoreCode, RTS_BOOL bInIecTask);
#if defined(CMPAPPBP_NOTIMPLEMENTED) || defined(APPBPDELETE2_NOTIMPLEMENTED)
	#define USE_AppBPDelete2
	#define EXT_AppBPDelete2
	#define GET_AppBPDelete2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_AppBPDelete2(p0,p1,p2)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_AppBPDelete2  FALSE
	#define EXP_AppBPDelete2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_AppBPDelete2
	#define EXT_AppBPDelete2
	#define GET_AppBPDelete2(fl)  CAL_CMGETAPI( "AppBPDelete2" ) 
	#define CAL_AppBPDelete2  AppBPDelete2
	#define CHK_AppBPDelete2  TRUE
	#define EXP_AppBPDelete2  CAL_CMEXPAPI( "AppBPDelete2" ) 
#elif defined(MIXED_LINK) && !defined(CMPAPPBP_EXTERNAL)
	#define USE_AppBPDelete2
	#define EXT_AppBPDelete2
	#define GET_AppBPDelete2(fl)  CAL_CMGETAPI( "AppBPDelete2" ) 
	#define CAL_AppBPDelete2  AppBPDelete2
	#define CHK_AppBPDelete2  TRUE
	#define EXP_AppBPDelete2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"AppBPDelete2", (RTS_UINTPTR)AppBPDelete2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpAppBPAppBPDelete2
	#define EXT_CmpAppBPAppBPDelete2
	#define GET_CmpAppBPAppBPDelete2  ERR_OK
	#define CAL_CmpAppBPAppBPDelete2 pICmpAppBP->IAppBPDelete2
	#define CHK_CmpAppBPAppBPDelete2 (pICmpAppBP != NULL)
	#define EXP_CmpAppBPAppBPDelete2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_AppBPDelete2
	#define EXT_AppBPDelete2
	#define GET_AppBPDelete2(fl)  CAL_CMGETAPI( "AppBPDelete2" ) 
	#define CAL_AppBPDelete2 pICmpAppBP->IAppBPDelete2
	#define CHK_AppBPDelete2 (pICmpAppBP != NULL)
	#define EXP_AppBPDelete2  CAL_CMEXPAPI( "AppBPDelete2" ) 
#else /* DYNAMIC_LINK */
	#define USE_AppBPDelete2  PFAPPBPDELETE2 pfAppBPDelete2;
	#define EXT_AppBPDelete2  extern PFAPPBPDELETE2 pfAppBPDelete2;
	#define GET_AppBPDelete2(fl)  s_pfCMGetAPI2( "AppBPDelete2", (RTS_VOID_FCTPTR *)&pfAppBPDelete2, (fl), 0, 0)
	#define CAL_AppBPDelete2  pfAppBPDelete2
	#define CHK_AppBPDelete2  (pfAppBPDelete2 != NULL)
	#define EXP_AppBPDelete2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"AppBPDelete2", (RTS_UINTPTR)AppBPDelete2, 0, 0) 
#endif
...
class ICmpAppBP : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL IAppBPDelete2(Breakpoint *pbp, RTS_BOOL bRestoreCode, RTS_BOOL bInIecTask) =0;
};
	#ifndef ITF_CmpAppBP
