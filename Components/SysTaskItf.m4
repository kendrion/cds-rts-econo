 ...
 * <result>Configured priority</result>
 */
DEF_HANDLEITF_API(`RTS_UI32',`CDECL',`SysTaskGetConfiguredPriority2',`(RTS_HANDLE hTask, RTS_UI32 ulPriority, RTS_RESULT *pResult)')
 ...
 * <result>error code</result>
 */
DEF_HANDLEITF_API(`RTS_RESULT',`CDECL',`SysTaskGetInterval',`(RTS_HANDLE hTask, RTS_UI32 *pulInterval)')
