...
typedef struct
{
	RTS_IEC_DINT *pSummand1;
	RTS_IEC_DINT nSummand2;
	RTS_IEC_DINT out;
} exchange_and_add_struct;
...
typedef struct
{
	RTS_IEC_XWORD *pAddress;
	RTS_IEC_XWORD xwExpected;
	RTS_IEC_XWORD xwNewValue;
	RTS_IEC_BOOL out;
} compare_and_swap_struct;
...
/**
 * <description>
 * This function atomically adds a value to the value at a specific address. It works only
 * on 32Bit values. It can only fail if the pointer, passed to the function is NULL. In this
 * case, the behavior is unspecified.
 * When the operation was successful, it will return the original value of the value at the
 * address, specified by pSummand1.
 * Note: This function roughly imitates the XADD instruction of an x86 processor.
 * </description>
 * <param name="p" type="IN" range="[VALID_EXCHANGE_AND_ADD_STRUCT]">Pointer to the input structure</param>
 * <parampseudo name="pSummand1" type="IN" range="[NULL,VALID_EAA_POINTER]">This is the address of the value, which contains the first summand and the result.</parampseudo>
 * <parampseudo name="pSummand1Value" type="INOUT" range="[RTS_RANGE_OF_RTS_DWORD]">This is the value of the first summand.</parampseudo>
 * <parampseudo name="nSummand2" type="IN" range="[RTS_RANGE_OF_RTS_DWORD]">This is the value, which is added to the value at the address of pSummand1</parampseudo>
 * <parampseudo name="out" type="OUT">The result is the value at pSummand1 before the operation</parampseudo>
 */
void CDECL CDECL_EXT exchange__and__add(exchange_and_add_struct* p);
typedef void (CDECL * PFEXCHANGE__AND__ADD) (exchange_and_add_struct* p);
#if defined(SYSINTERNALLIB_NOTIMPLEMENTED) || defined(EXCHANGE__AND__ADD_NOTIMPLEMENTED)
	#define USE_exchange__and__add
	#define EXT_exchange__and__add
	#define GET_exchange__and__add(fl)  ERR_NOTIMPLEMENTED
	#define CAL_exchange__and__add(p0) 
	#define CHK_exchange__and__add  FALSE
	#define EXP_exchange__and__add  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_exchange__and__add
	#define EXT_exchange__and__add
	#define GET_exchange__and__add(fl)  CAL_CMGETAPI( "exchange__and__add" ) 
	#define CAL_exchange__and__add  exchange__and__add
	#define CHK_exchange__and__add  TRUE
	#define EXP_exchange__and__add  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"exchange__and__add", (RTS_UINTPTR)exchange__and__add, 1, 0) 
#elif defined(MIXED_LINK) && !defined(SYSINTERNALLIB_EXTERNAL)
	#define USE_exchange__and__add
	#define EXT_exchange__and__add
	#define GET_exchange__and__add(fl)  CAL_CMGETAPI( "exchange__and__add" ) 
	...
	#define EXP_exchange__and__add  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"exchange__and__add", (RTS_UINTPTR)exchange__and__add, 1, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_SysInternalLibexchange__and__add
	#define EXT_SysInternalLibexchange__and__add
	#define GET_SysInternalLibexchange__and__add  ERR_OK
	#define CAL_SysInternalLibexchange__and__add  exchange__and__add
	#define CHK_SysInternalLibexchange__and__add  TRUE
	#define EXP_SysInternalLibexchange__and__add  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"exchange__and__add", (RTS_UINTPTR)exchange__and__add, 1, 0) 
#elif defined(CPLUSPLUS)
	#define USE_exchange__and__add
	#define EXT_exchange__and__add
	#define GET_exchange__and__add(fl)  CAL_CMGETAPI( "exchange__and__add" ) 
	...
	#define EXP_exchange__and__add  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"exchange__and__add", (RTS_UINTPTR)exchange__and__add, 1, 0) 
#else /* DYNAMIC_LINK */
	#define USE_exchange__and__add  PFEXCHANGE__AND__ADD pfexchange__and__add;
	#define EXT_exchange__and__add  extern PFEXCHANGE__AND__ADD pfexchange__and__add;
	#define GET_exchange__and__add(fl)  s_pfCMGetAPI2( "exchange__and__add", (RTS_VOID_FCTPTR *)&pfexchange__and__add, (fl), 0, 0)
	#define CAL_exchange__and__add  pfexchange__and__add
	#define CHK_exchange__and__add  (pfexchange__and__add != NULL)
	#define EXP_exchange__and__add   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"exchange__and__add", (RTS_UINTPTR)exchange__and__add, 1, 0) 
#endif
 ...
 * </ul>
 * </description>
 * <param name="p" type="IN" range="[VALID_TEST_AND_SET_STRUCT]">Pointer to the input structure</param>
 * <parampseudo name="pdwTest" type="IN" range="[NULL,VALID_TAS_POINTER]">Pointer to the value, where the bit should be set</parampseudo>
 * <parampseudo name="pdwTestValue" type="INOUT" range="[RTS_RANGE_OF_RTS_DWORD]">Current value at the address of pdwTest</parampseudo>
 * <parampseudo name="out" type="OUT">0 if operation succeeded, &lt;&gt;0 if it failed</parampseudo>
 * <result>0 on success, &lt;&gt;0 on error</result>
 */
void CDECL CDECL_EXT test__and__set(test_and_set_struct* p);
typedef void (CDECL * PFTEST__AND__SET) (test_and_set_struct* p);
#if defined(SYSINTERNALLIB_NOTIMPLEMENTED) || defined(TEST__AND__SET_NOTIMPLEMENTED)
	#define USE_test__and__set
	#define EXT_test__and__set
	#define GET_test__and__set(fl)  ERR_NOTIMPLEMENTED
	#define CAL_test__and__set(p0) 
	#define CHK_test__and__set  FALSE
	#define EXP_test__and__set  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_test__and__set
	#define EXT_test__and__set
	#define GET_test__and__set(fl)  CAL_CMGETAPI( "test__and__set" ) 
	#define CAL_test__and__set  test__and__set
	#define CHK_test__and__set  TRUE
	#define EXP_test__and__set  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"test__and__set", (RTS_UINTPTR)test__and__set, 1, 0) 
#elif defined(MIXED_LINK) && !defined(SYSINTERNALLIB_EXTERNAL)
	#define USE_test__and__set
	#define EXT_test__and__set
	#define GET_test__and__set(fl)  CAL_CMGETAPI( "test__and__set" ) 
	...
	#define EXP_test__and__set  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"test__and__set", (RTS_UINTPTR)test__and__set, 1, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_SysInternalLibtest__and__set
	#define EXT_SysInternalLibtest__and__set
	#define GET_SysInternalLibtest__and__set  ERR_OK
	#define CAL_SysInternalLibtest__and__set  test__and__set
	#define CHK_SysInternalLibtest__and__set  TRUE
	#define EXP_SysInternalLibtest__and__set  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"test__and__set", (RTS_UINTPTR)test__and__set, 1, 0) 
#elif defined(CPLUSPLUS)
	#define USE_test__and__set
	#define EXT_test__and__set
	#define GET_test__and__set(fl)  CAL_CMGETAPI( "test__and__set" ) 
	...
	#define EXP_test__and__set  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"test__and__set", (RTS_UINTPTR)test__and__set, 1, 0) 
#else /* DYNAMIC_LINK */
	#define USE_test__and__set  PFTEST__AND__SET pftest__and__set;
	#define EXT_test__and__set  extern PFTEST__AND__SET pftest__and__set;
	#define GET_test__and__set(fl)  s_pfCMGetAPI2( "test__and__set", (RTS_VOID_FCTPTR *)&pftest__and__set, (fl), 0, 0)
	#define CAL_test__and__set  pftest__and__set
	#define CHK_test__and__set  (pftest__and__set != NULL)
	#define EXP_test__and__set   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"test__and__set", (RTS_UINTPTR)test__and__set, 1, 0) 
#endif
...
/**
 * <description>
 * This function copies xwNewValue to the location where pAddress points to. It
 * fails if the value at the location doesn't match the value of  xwExpected.
 * When the operation fails, the value at pAddress remains untouched.
 *
 * Possible errors:
 * <ul>
 *     <li>Value at pAddress doesn't match the value of xwExpected</li>
 *     <li>pAddress was NULL</li>
 *     <li>Swap is not supported on the size of an XWORD on this platform.</li>
 * </ul>
 * </description>
 * <param name="p" type="IN" range="[VALID_COMPARE_AND_SWAP_STRUCT]">Pointer to the input structure</param>
 * <parampseudo name="pAddressValue" type="INOUT" range="[RTS_RANGE_OF_RTS_IEC_XWORD]">Current value at the location of pAddress.</parampseudo>
 ...
 */
void CDECL CDECL_EXT compare__and__swap(compare_and_swap_struct* p);
typedef void (CDECL * PFCOMPARE__AND__SWAP) (compare_and_swap_struct* p);
#if defined(SYSINTERNALLIB_NOTIMPLEMENTED) || defined(COMPARE__AND__SWAP_NOTIMPLEMENTED)
	#define USE_compare__and__swap
	#define EXT_compare__and__swap
	#define GET_compare__and__swap(fl)  ERR_NOTIMPLEMENTED
	#define CAL_compare__and__swap(p0) 
	#define CHK_compare__and__swap  FALSE
	#define EXP_compare__and__swap  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_compare__and__swap
	#define EXT_compare__and__swap
	#define GET_compare__and__swap(fl)  CAL_CMGETAPI( "compare__and__swap" ) 
	#define CAL_compare__and__swap  compare__and__swap
	#define CHK_compare__and__swap  TRUE
	#define EXP_compare__and__swap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"compare__and__swap", (RTS_UINTPTR)compare__and__swap, 1, 0) 
#elif defined(MIXED_LINK) && !defined(SYSINTERNALLIB_EXTERNAL)
	#define USE_compare__and__swap
	#define EXT_compare__and__swap
	#define GET_compare__and__swap(fl)  CAL_CMGETAPI( "compare__and__swap" ) 
	...
	#define EXP_compare__and__swap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"compare__and__swap", (RTS_UINTPTR)compare__and__swap, 1, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_SysInternalLibcompare__and__swap
	#define EXT_SysInternalLibcompare__and__swap
	#define GET_SysInternalLibcompare__and__swap  ERR_OK
	#define CAL_SysInternalLibcompare__and__swap  compare__and__swap
	#define CHK_SysInternalLibcompare__and__swap  TRUE
	#define EXP_SysInternalLibcompare__and__swap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"compare__and__swap", (RTS_UINTPTR)compare__and__swap, 1, 0) 
#elif defined(CPLUSPLUS)
	#define USE_compare__and__swap
	#define EXT_compare__and__swap
	#define GET_compare__and__swap(fl)  CAL_CMGETAPI( "compare__and__swap" ) 
	...
	#define EXP_compare__and__swap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"compare__and__swap", (RTS_UINTPTR)compare__and__swap, 1, 0) 
#else /* DYNAMIC_LINK */
	#define USE_compare__and__swap  PFCOMPARE__AND__SWAP pfcompare__and__swap;
	#define EXT_compare__and__swap  extern PFCOMPARE__AND__SWAP pfcompare__and__swap;
	#define GET_compare__and__swap(fl)  s_pfCMGetAPI2( "compare__and__swap", (RTS_VOID_FCTPTR *)&pfcompare__and__swap, (fl), 0, 0)
	#define CAL_compare__and__swap  pfcompare__and__swap
	#define CHK_compare__and__swap  (pfcompare__and__swap != NULL)
	#define EXP_compare__and__swap   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"compare__and__swap", (RTS_UINTPTR)compare__and__swap, 1, 0) 
#endif
