...
DEF_API(`void',`CDECL',`syssock2accept',`(syssock2accept_struct *p)',1,0x17C31CE6,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2bind',`(syssock2bind_struct *p)',1,0x1AA54880,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2close',`(syssock2close_struct *p)',1,0xEE4C98E7,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2connect',`(syssock2connect_struct *p)',1,0x482EC7EC,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2create',`(syssock2create_struct *p)',1,0xF631E049,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2fdinit',`(syssock2fdinit_struct *p)',1,0xAD038A02,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2fdisset',`(syssock2fdisset_struct *p)',1,0x838C8AA3,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2getoption',`(syssock2getoption_struct *p)',1,0xE48066F9,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2getpeername',`(syssock2getpeername_struct *p)',1,0x4D1F4B79,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2getsockname',`(syssock2getsockname_struct *p)',1,0xCD3D4AC3,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2ioctl',`(syssock2ioctl_struct *p)',1,0xCF1E8764,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2listen',`(syssock2listen_struct *p)',1,0xC76C27A4,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2recv',`(syssock2recv_struct *p)',1,RTSITF_GET_SIGNATURE(0xB660C00E, 0xC68B1F2F),0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2recvfrom',`(syssock2recvfrom_struct *p)',1,RTSITF_GET_SIGNATURE(0x1109A6B6, 0xE3F1F6D3),0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2select',`(syssock2select_struct *p)',1,0x027528F5,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2send',`(syssock2send_struct *p)',1,RTSITF_GET_SIGNATURE(0x92166851, 0xE2FDB770),0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2sendto',`(syssock2sendto_struct *p)',1,RTSITF_GET_SIGNATURE(0xBC837B5E, 0x5311AA5A),0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2setoption',`(syssock2setoption_struct *p)',1,0x442C7F14,0x03050E00)
...
DEF_API(`void',`CDECL',`syssock2shutdown',`(syssock2shutdown_struct *p)',1,0x775B849E,0x03050E00)
