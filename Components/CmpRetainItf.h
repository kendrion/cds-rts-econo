 ...
 * <element name="ulRetainSize" type="IN">Size of the SRAM in bytes</element>
 */
typedef struct
{
...
*	<element name="CMPRETAIN_DELETEOPTION_REMOVE_AND_RESERVE" type="IN">remove retain memory from retain management and mark used segments as reserved. Don't delete retain file!</element> 
 */
#define CMPRETAIN_DELETEOPTION_REMOVE				0
#define CMPRETAIN_DELETEOPTION_ALL					1
#define CMPRETAIN_DELETEOPTION_REMOVE_AND_FREE		2
#define CMPRETAIN_DELETEOPTION_REMOVE_AND_RESERVE	3
