 ...
 *  target OS is real Windows, 
 *  or if it is Windows CE >= 6 with at least 48 MB free RAM
 *  Then we take 0x9600000 bytes as default (1920 * 1280 * 4 pixels)
 *  
 * </description>
 */	
...
#endif
#ifndef SYSGRAPHIC_WIN32_MAX_JPEG_BYTEARRAY_SIZE_DEFAULT_MODERN
	#define SYSGRAPHIC_WIN32_MAX_JPEG_BYTEARRAY_SIZE_DEFAULT_MODERN	INT32_C(9830400)
#endif
...
/**
 * <description>Function to Set the radius of a round rectangle</description>
 * <param name="hDC" type="IN">Handle to device context</param>
 * <param name="iRadiusX" type="IN">Radius X</param>
 * <param name="iRadiusY" type="IN">Radius Y</param>
 * <result>error code</result>
 */
RTS_RESULT CDECL SysGraphicSetRoundRectRadius(RTS_HANDLE hDC, RTS_I16 iRadiusX, RTS_I16 iRadiusY);
typedef RTS_RESULT (CDECL * PFSYSGRAPHICSETROUNDRECTRADIUS) (RTS_HANDLE hDC, RTS_I16 iRadiusX, RTS_I16 iRadiusY);
#if defined(SYSGRAPHIC_NOTIMPLEMENTED) || defined(SYSGRAPHICSETROUNDRECTRADIUS_NOTIMPLEMENTED)
	#define USE_SysGraphicSetRoundRectRadius
	#define EXT_SysGraphicSetRoundRectRadius
	#define GET_SysGraphicSetRoundRectRadius(fl)  ERR_NOTIMPLEMENTED
	#define CAL_SysGraphicSetRoundRectRadius(p0,p1,p2) (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_SysGraphicSetRoundRectRadius  FALSE
	#define EXP_SysGraphicSetRoundRectRadius  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_SysGraphicSetRoundRectRadius
	#define EXT_SysGraphicSetRoundRectRadius
	#define GET_SysGraphicSetRoundRectRadius(fl)  CAL_CMGETAPI( "SysGraphicSetRoundRectRadius" ) 
	#define CAL_SysGraphicSetRoundRectRadius  SysGraphicSetRoundRectRadius
	#define CHK_SysGraphicSetRoundRectRadius  TRUE
	#define EXP_SysGraphicSetRoundRectRadius  CAL_CMEXPAPI( "SysGraphicSetRoundRectRadius" ) 
#elif defined(MIXED_LINK) && !defined(SYSGRAPHIC_EXTERNAL)
	#define USE_SysGraphicSetRoundRectRadius
	#define EXT_SysGraphicSetRoundRectRadius
	#define GET_SysGraphicSetRoundRectRadius(fl)  CAL_CMGETAPI( "SysGraphicSetRoundRectRadius" ) 
	#define CAL_SysGraphicSetRoundRectRadius  SysGraphicSetRoundRectRadius
	#define CHK_SysGraphicSetRoundRectRadius  TRUE
	#define EXP_SysGraphicSetRoundRectRadius  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"SysGraphicSetRoundRectRadius", (RTS_UINTPTR)SysGraphicSetRoundRectRadius, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_SysGraphicSysGraphicSetRoundRectRadius
	#define EXT_SysGraphicSysGraphicSetRoundRectRadius
	#define GET_SysGraphicSysGraphicSetRoundRectRadius  ERR_OK
	#define CAL_SysGraphicSysGraphicSetRoundRectRadius  SysGraphicSetRoundRectRadius
	#define CHK_SysGraphicSysGraphicSetRoundRectRadius  TRUE
	#define EXP_SysGraphicSysGraphicSetRoundRectRadius  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_SysGraphicSetRoundRectRadius
	#define EXT_SysGraphicSetRoundRectRadius
	#define GET_SysGraphicSetRoundRectRadius(fl)  CAL_CMGETAPI( "SysGraphicSetRoundRectRadius" ) 
	...
	#define EXP_SysGraphicSetRoundRectRadius  CAL_CMEXPAPI( "SysGraphicSetRoundRectRadius" ) 
#else /* DYNAMIC_LINK */
	#define USE_SysGraphicSetRoundRectRadius  PFSYSGRAPHICSETROUNDRECTRADIUS pfSysGraphicSetRoundRectRadius;
	#define EXT_SysGraphicSetRoundRectRadius  extern PFSYSGRAPHICSETROUNDRECTRADIUS pfSysGraphicSetRoundRectRadius;
	#define GET_SysGraphicSetRoundRectRadius(fl)  s_pfCMGetAPI2( "SysGraphicSetRoundRectRadius", (RTS_VOID_FCTPTR *)&pfSysGraphicSetRoundRectRadius, (fl), 0, 0)
	#define CAL_SysGraphicSetRoundRectRadius  pfSysGraphicSetRoundRectRadius
	#define CHK_SysGraphicSetRoundRectRadius  (pfSysGraphicSetRoundRectRadius != NULL)
	#define EXP_SysGraphicSetRoundRectRadius   s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"SysGraphicSetRoundRectRadius", (RTS_UINTPTR)SysGraphicSetRoundRectRadius, 0, 0) 
#endif
